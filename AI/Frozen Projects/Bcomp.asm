...
;REV 4 LAST UPDATED 19/06/2009 1400

;CODE COMPLETED 21/06/2009 2230 ::: WORKING TESTED ::: PERFECT :: GLITCH00:DURING POWERDOWN SENT '0' NOT RECEIVED
...
INRAN:		NOP
			...
			JB 79H,POWERDWN		;IF 'Z' IS RECEIVED, POWER DOWN
...
SERCON:		CLR TR2
			...
			MOV A,SBUF
			JB PSW.5,SKIPC
			CJNE A,#31H,EXITC0			;PSW.5 SET IMPLIES CONNECTION ESTABLISHED
